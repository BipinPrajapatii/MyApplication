        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address2 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Id", "Address1", "Address2", "City", "Country", "CreatedBy", "CreatedOn", "Email", "EndDate", "FirstName", "LastName", "LastSyncedDateTime", "MaxUser", "Name", "PhoneNo", "StartDate", "State", "UpdatedBy", "UpdatedOn", "ZipCode" },
                values: new object[,]
                {
                    { 1, "Address Line 1", "Address Line 2", "Surat", "India", null, null, "noemail@noemail.com", new DateTime(2026, 2, 16, 9, 19, 38, 666, DateTimeKind.Utc).AddTicks(1854), "Surat", "Contact", null, 5, "Surat Company", "1234567890", new DateTime(2025, 2, 16, 9, 19, 38, 666, DateTimeKind.Utc).AddTicks(1883), "Gujarat", null, null, "395000" },
                    { 2, "Address Line 1", "Address Line 2", "Mumbai", "India", null, null, "nocontact@nocontact.com", new DateTime(2025, 6, 16, 9, 19, 38, 666, DateTimeKind.Utc).AddTicks(1891), "Mumbai", "Contact", null, 3, "Mumbai Company", "1234567890", new DateTime(2025, 2, 16, 9, 19, 38, 666, DateTimeKind.Utc).AddTicks(1894), "Maharastra", null, null, "411000" }
                });
